...
Writer.prototype._parse_qusertype = function(obj){
    if (qtdatastream.isUserTypeComplex(obj.getName())) {
        ...
        for (var item = iter.first(); iter.hasNext(); item = iter.next()) {
            this._parse(new qtdatastream.Class[item.value](obj.obj[item.key]));
        }
    } else {
        var type = this.getUserTypeIterator(obj.getName());
...
Writer.prototype._parse_class = function(obj, key, newclass){
    if (obj.obj[key] instanceof newclass) {
        ...
        if (typeof obj.obj[key]._qclass !== 'undefined'
            && qtdatastream.QTDATASTREAMCLASS === obj.obj[key]._qclass) {
            this._parse(new newclass(obj.obj[key].obj));
        } else {
