...
exports.simple_types = {
  setUp: function(done) {
    this.data = [
      ...
      new TestData(types.QDateTime, new Date(2012, 1, 2, 1, 1, 1), Buffer.from([ 0x00, 0x25, 0x79, 0x98, 0x00, 0x37, 0xdc, 0xc8, 0x00 ])),
...
exports.qvariant = {
  setUp: function(done) {
    this.data = [
      ...
      new ElaboratedTestData(types.QVariant, new types.QVariant(new Date(2012, 1, 2, 1, 1, 1)), Buffer.from([ 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x25, 0x79, 0x98, 0x00, 0x37, 0xdc, 0xc8, 0x00 ]), new Date(2012, 1, 2, 1, 1, 1)),
    ];
    done();
  },
  'no args': function(test) {
